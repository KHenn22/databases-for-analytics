...
\copy city (name, country_code, district, population, local_name) FROM 'city_utf8.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', QUOTE '"');
\copy country (code, name, continent, region, surface_area, indep_year, population, life_expectancy, gnp, gnp_old, local_name, government_form, head_of_state, capital, code2) FROM 'country_utf8.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', QUOTE '"');
\copy country_language (country_code, "language", is_official, percentage) FROM 'country_language_utf8.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', QUOTE '"');
\copy country_flag (code2, emoji, unicode) FROM 'country_flag_utf8.csv' WITH (FORMAT csv, HEADER true, DELIMITER ',', QUOTE '"');
